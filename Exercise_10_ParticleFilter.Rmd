...
smooth.params <- function(params,h=1){
  ...
  params.star = as.list(params.star)
  params.star[c("falloc.1","falloc.2","falloc.3")] = NULL
  params.star[["falloc"]] = unname(as.matrix(falloc))
  return(params.star)
}
```
...
ParticleFilter <- function(out,params,dat,wt=1){
  ...
  if(Neff < ne/2){
    ...
    params = smooth.params(as.data.frame(params)[index,],h=0.95) ## kernel smooth updated parameters
