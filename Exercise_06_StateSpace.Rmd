...
* The "Data Model" section is the same as in our random walk except for the addition of code for the means of the covariates. This code isn't here as a very simple missing data model -- any time the covariate is observed it is used to estimate the mean an precision, but any time the covariate is NA it is imputed.
...
* Explain and discuss the parameter estimates (betas) from the linear model
