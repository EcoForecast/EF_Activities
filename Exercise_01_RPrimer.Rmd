...
Enter the following address in the Repository URL: https://github.com/EcoForecast/EF_Activities.git
...
If you anticipate making changes to a git project on GitHub then, instead of cloning from https://github.com/EcoForecast/EF_Activities you should go to that website and click on the "Fork" button in the top right corner. This requires that you have an account on GitHub, which is free and easy to set up. Once you fork the repository, this will make a copy to https://github.com/username/EF_Activities where _username_ is your GitHub username, and you can use that as your Repository URL.
