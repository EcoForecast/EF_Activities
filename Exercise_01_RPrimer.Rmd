...
2.	**What is the difference between log and log10?**  (Hint: use help!)
...
4.	**Generate a sequence of even numbers from -6 to 6**
5.	**Generate a sequence of values from -4.8 to -3.43 that is length 8** (show code)
...
6.	**Create a character vector that contains the names of 4 people you admire.**
...
7. Use R commands (e.g., do not click "import dataset" and use the dialog there) read in the file  `met_hourly.csv` (which is in the `data` directory) and assign it the variable name `met`

8. Save the matrix `x` to a csv file
...
9. Use the commands above to explore the contents of `met`. Describe in words what this file contains and some of its characteristics.
...
10. **Show the 1033rd through 1056th row of weather data**

11. **Show the 3rd through 8th rows of the 1st though 3rd columns of the frog data**

12. **What was the _total_ amount of rain?** Hint: look back at Vector Math
...
13. **Using the frog data, show just the spots column as characters**
...
## ★ Questions (15)
15. **Use apply to calculate the across-population standard deviations in the numbers of frogs and tadpoles**
...
## ★ Questions (16-18)
16. **Plot a histogram of blue frogs**
17. **Plot shortwave (solar) radiation against time**
18. **Plot shortwave (solar) radiation against relative humidity**
...
## ★ Questions (19)
19. **Modify the logistic growth code to simulate discrete-time exponential growth and plot the output.**
