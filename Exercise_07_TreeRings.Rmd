...
```{r}
library(rjags)
# Install the ecoforecastR package off github by running this command:
...
* While the `fit_dlm` function discussed in Exercise 06 doesn't yet support data fusion models or multivariate models, the `ParseFixed` function can be used to help expand a basic random walk model to a more complex model.
